...
/* =========================================================
   REVIEWER PAGE SEO
========================================================= */
function useReviewerPageSeo() {
  useEffect(() => {
    const previousTitle = document.title;
    const pageUrl = "https://www.globalreviewspress.com/reviewer";
    const title = "Become a Peer Reviewer | Global Reviews Press";
    const description =
      "Join the Global Reviews Press peer reviewer network. Review academic manuscripts, support research quality, gain recognition and contribute your expertise to global scholarly publishing.";
    const imageUrl =
      "https://www.globalreviewspress.com/global-reviews-press-reviewer-social-preview.webp";
    ...
    setMeta(
      "name",
      "keywords",
      "Global Reviews Press reviewer, become a peer reviewer, academic peer review, manuscript reviewer, journal reviewer, scholarly publishing reviewer, reviewer network, research quality, peer review opportunities",
    );
    ...
    setMeta(
      "property",
      "og:image:alt",
      "Become a peer reviewer with Global Reviews Press",
    );
    ...
    setMeta(
      "name",
      "twitter:image:alt",
      "Global Reviews Press peer reviewer network",
    );
    ...
    schema.dataset.pageSchema = "grp-reviewer";
